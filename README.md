...
<p>This section contains a form to subscribe to a newsletter on all devices and additionally contact information (email address) and my location including a Google Maps insert is included on large and xxl PC screens (on mobile device no map is provided, but my email address and link is inserted into the footer. A modal is included to obtain a link to the Terms and Conditions and can be accessed by clicking the link "Accept Terms and Conditions".</p>
